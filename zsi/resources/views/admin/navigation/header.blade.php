            ...
            <div class="d-flex">
                ...
                <div class="navbar-brand-box horizontal-logo">
                    <a href="" class="logo logo-dark">
                        <span class="logo-sm">
                            <img src="{{ asset('logo-dark-sm.png') }}" alt="Logo" height="22">
                        </span>
                        <span class="logo-lg">
                            <img src="{{ asset('logo-dark-lg.png') }}" alt="Logo" height="17">
                        </span>
                    </a>

                    <a href="" class="logo logo-light">
                        <span class="logo-sm">
                            <img src="{{ asset('logo-light-sm.png') }}" alt="Logo" height="22">
                        </span>
                        <span class="logo-lg">
                            <img src="{{ asset('logo-light-lg.png') }}" alt="Logo" height="17">
                        </span>
                    </a>
                </div>
                                        ...
                                        <div class="d-flex">
                                            ...
                                            <div class="flex-grow-1">
                                                <a href="#!" class="stretched-link">
                                                    <h6 class="mt-0 mb-2 lh-base">Welcome To Survey Institute of Zimbabwe Portal <span class="text-secondary"></span> is ready!</h6>
                                                </a>
                                                <p class="mb-0 fs-11 fw-medium text-uppercase text-muted">
                                                    <span><i class="mdi mdi-clock-outline"></i> 04/06/2024</span>
                                                </p>
                                            </div>
